...
export default function AtendimentosUpload({ showRent = true, showSale = true }) {
  const { setAtendimentosRent, setAtendimentosSale } = useContracts();
  ...
  return (
    ...
    >
      {showRent && (
        <UploadCard
          title="Planilha de atendimentos (Aluguel)"
          description="Importe a base de atendimentos de aluguel"
          onSelect={setAtendimentosRent}
        />
      )}
      {showSale && (
        <UploadCard
          title="Planilha de atendimentos (Venda)"
          description="Importe a base de atendimentos de venda"
          onSelect={setAtendimentosSale}
        />
      )}
    </div>
  );

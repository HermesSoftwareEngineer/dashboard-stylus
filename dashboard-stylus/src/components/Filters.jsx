    ...
    <div className="bg-white dark:bg-black border-b border-gray-200 dark:border-neutral-800 px-4 lg:px-6 py-3">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="px-3 py-2 text-xs rounded-lg border border-gray-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-950 text-gray-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-neutral-600"
        >
          {PERIODS.map((p) => (
        ...
        <label className="text-xs uppercase tracking-wide text-gray-500 dark:text-neutral-400 font-semibold ml-4">
          Granularidade
        </label>
        <select
